...
default() {
    ...
    kubectl label namespace khipster istio-injection=enabled --overwrite=true
    kubectl apply -f kstore-${suffix}/
    kubectl apply -f kinvoice-${suffix}/
    kubectl apply -f kproduct-${suffix}/
    kubectl apply -f knotification-${suffix}/

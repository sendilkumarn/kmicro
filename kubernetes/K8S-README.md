...
```
$ docker image tag kstore sendilkumarn/kstore
$ docker push sendilkumarn/kstore
$ docker image tag kinvoice sendilkumarn/kinvoice
$ docker push sendilkumarn/kinvoice
$ docker image tag kproduct sendilkumarn/kproduct
$ docker push sendilkumarn/kproduct
$ docker image tag knotification sendilkumarn/knotification
$ docker push sendilkumarn/knotification
```
...
```
$ kubectl get svc kstore -n khipster
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n khipster
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n khipster
```

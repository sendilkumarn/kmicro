package com.sendilkumarn.sample.kinvoice.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.sendilkumarn.sample.kinvoice.repository..*)" +
            " || within(com.sendilkumarn.sample.kinvoice.service..*)" +
            " || within(com.sendilkumarn.sample.kinvoice.web.rest..*)"
    )

package com.sendilkumarn.sample.kinvoice

import com.sendilkumarn.sample.kinvoice.config.ApplicationProperties
...
class KinvoiceApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes kinvoice.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KinvoiceApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KinvoiceApp::class.java)
